  ...
  return (
    <React.Fragment>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {user ? (
              <>
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-700 group-hover:text-purple-700 transition-colors">Mesajlar</span>
                ...
                <div className="relative" ref={notificationRef}>
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-gray-700 group-hover:text-purple-700 transition-colors">Bildirimler</span>
                    {unreadCount > 0 && (
                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 py-2 z-50">
                      ...
                      {user.role === 'admin' && (
                        <>
                          ...
                          >
                            <Shield className="w-4 h-4" />
                            <span className="font-semibold">Değişim Kontrol</span>
                          </Link>
                        </>
                      )}
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200/50 bg-white/90 backdrop-blur-xl rounded-2xl mt-2">
