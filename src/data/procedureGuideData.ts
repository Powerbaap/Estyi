...
export type LangText = { tr: string; en: string; ar: string; fr: string; es: string; ru: string };
...
export const PROCEDURE_GUIDES: ProcedureGuideInfo[] = [
  {
    ...
    title: {
      ...
      ru: 'Пересадка волос FUE - гид 2026 и цены',
    },
    metaDescription: {
      ...
      ru: 'Что такое пересадка волос FUE, как она выполняется и сколько стоит? Гид 2026, восстановление и сравнение стран.',
    },
    summary: {
      ...
      ru: 'FUE (Follicular Unit Extraction) — метод, при котором фолликулы по одному извлекают из донорской зоны и пересаживают в область облысения. Без швов, с минимальными следами и естественным результатом.',
    },
    priceRange: {
    ...
    suitableFor: [
      {
        ...
        ru: 'Люди с андрогенетической алопецией',
      },
      {
        ...
        ru: 'Люди с достаточной донорской зоной',
      },
      {
        ...
        ru: 'Желающие скорректировать линию роста волос',
      },
    ],
    notSuitableFor: [
      {
        ...
        ru: 'Люди с очень слабой донорской зоной',
      },
      {
        ...
        ru: 'Люди с хроническими заболеваниями (нужно одобрение врача)',
      },
    ],
    risks: [
      {
        ...
        ru: 'Временный отёк и припухлость',
      },
      {
      ...
      },
      {
        ...
        ru: 'Шоковое выпадение (нормальный процесс)',
      },
    ],
    steps: [
      {
        ...
        desc: {
          ...
          ru: 'Проводится анализ волос, определяется линия роста и рассчитывается количество графтов.',
        },
      },
      {
        title: {
        ...
        desc: {
          ...
          ru: 'Под местной анестезией графты извлекаются по одному с помощью микромотора.',
        },
      },
      {
        title: {
        ...
        desc: {
          ...
          ru: 'В зоне пересадки формируются каналы с использованием сапфировых наконечников.',
        },
      },
      {
        title: {
        ...
        desc: {
          ...
          ru: 'Извлечённые графты устанавливаются в сформированные каналы.',
        },
      },
    ],
    faq: [
      {
        q: {
          ...
          ru: 'Больно ли делать пересадку волос FUE?',
        },
        a: {
          ...
          ru: 'Процедура проводится под местной анестезией, поэтому боли нет. После возможен лёгкий дискомфорт.',
        },
      },
      {
        q: {
          ...
          ru: 'Когда можно вернуться к работе?',
        },
        a: {
          ...
          ru: 'Обычно к социальной активности и офисной работе можно вернуться через 3–5 дней.',
        },
      },
    ],
  ...
  },
  {
    ...
    title: {
      ...
      ru: 'Пересадка волос DHI - гид 2026 и цены',
    },
    metaDescription: {
      ...
      ru: 'Что такое пересадка волос DHI (ручка Чои)? Преимущества пересадки без бритья, стоимость и отличия от FUE.',
    },
    summary: {
      ...
      ru: 'DHI (Direct Hair Implantation) — метод, при котором с помощью ручек Чои каналы формируются и графты имплантируются одновременно. Даёт более высокую плотность и более быстрое восстановление.',
    },
    priceRange: {
    ...
    suitableFor: [
      {
        ...
        ru: 'Желающие пересадку без бритья',
      },
      {
        ...
        ru: 'Кто хочет более плотную пересадку',
      },
      {
        ...
        ru: 'Идеально подходит для женщин',
      },
    ],
    notSuitableFor: [
      {
        ...
        ru: 'При очень больших зонах облысения (FUE может подойти лучше)',
      },
      {
        ...
        ru: 'Люди с кудрявыми волосами (иногда сложнее)',
      },
    ],
    risks: [
      {
      ...
      },
      {
        ...
        ru: 'Стоимость выше по сравнению с FUE',
      },
    ],
    steps: [
      {
        ...
        desc: {
          ...
          ru: 'Местная анестезия и извлечение графтов из донорской зоны (как при FUE).',
        },
      },
      {
        title: {
        ...
        desc: {
          ...
          ru: 'Графты помещают в ручку и вводят непосредственно в кожу.',
        },
      },
    ],
    faq: [
      {
        ...
        a: {
          ...
          ru: 'DHI чаще выбирают для уплотнения и линии роста, а FUE — для больших зон.',
        },
      },
    ],
    category: { tr: 'Saç Ekimi', en: 'Hair Transplant', ar: 'زراعة الشعر' },
  },
  {
    ...
    title: {
      ...
      ru: 'Ринопластика (операция на носу) — гид 2026',
    },
    metaDescription: {
      ...
      ru: 'Ринопластика: цены и восстановление. Различия между открытой и закрытой ринопластикой.',
    },
    summary: {
      ...
      ru: 'Ринопластика — хирургическая операция для коррекции формы и функции носа. Улучшает внешний вид и может решить проблемы с дыханием.',
    },
    priceRange: {
    ...
    suitableFor: [
      {
        ...
        ru: 'Люди, недовольные формой носа',
      },
      {
      ...
      },
      {
        ...
        ru: 'Люди с деформацией после травмы',
      },
    ],
    notSuitableFor: [
      {
        ...
        ru: 'Не завершено формирование костей (до 18 лет)',
      },
      {
        ...
        ru: 'Люди с нереалистичными ожиданиями',
      },
    ],
    risks: [
      {
      ...
      },
      {
        ...
        ru: 'Затруднённое дыхание (временно)',
      },
      {
        ...
        ru: 'Необходимость повторной коррекции (5–10%)',
      },
    ],
    steps: [
      {
        title: { tr: 'Kesi', en: 'Incision', ar: 'شق', fr: 'Incision', es: 'Incisión', ru: 'Разрез' },
        desc: {
          ...
          ru: 'Разрез выполняют внутри носа или под колумеллой (открытый/закрытый метод).',
        },
      },
      {
        title: { tr: 'Şekillendirme', en: 'Reshaping', ar: 'إعادة تشكيل', fr: 'Remodelage', es: 'Remodelación', ru: 'Моделирование' },
        desc: {
          ...
          ru: 'Хрящ и костные структуры моделируются заново.',
        },
      },
      {
        title: { tr: 'Kapatma', en: 'Closing', ar: 'إغلاق', fr: 'Fermeture', es: 'Cierre', ru: 'Закрытие' },
        desc: {
          ...
          ru: 'Разрезы закрывают и накладывают шину.',
        },
      },
    ],
    faq: [
      {
        ...
        a: {
          ...
          ru: 'Обычно силиконовые тампоны снимают через 2–3 дня.',
        },
      },
    ],
  ...
  },
  {
    ...
    title: {
      ...
      ru: 'Лечение зубными имплантами — цены 2026',
    },
    metaDescription: {
      ...
      ru: 'Имплантация при отсутствии зубов: титановый винт, техника All-on-4 и стоимость.',
    },
    summary: {
      ...
      ru: 'Зубные импланты — это искусственные корни, устанавливаемые в челюстную кость для замены отсутствующих зубов. Это самая близкая альтернатива натуральному зубу.',
    },
    priceRange: {
      india: '400 - 800 USD',
    ...
    suitableFor: [
      {
        ...
        ru: 'Люди с отсутствием одного или нескольких зубов',
      },
      {
        ...
        ru: 'Люди с подходящей костной структурой',
      },
    ],
    notSuitableFor: [
      {
        ...
        ru: 'При выраженной потере костной ткани (может потребоваться костная пластика)',
      },
      {
        ...
        ru: 'Пациенты с неконтролируемым диабетом',
      },
    ],
    risks: [
      { tr: 'Enfeksiyon', en: 'Infection', ar: 'عدوى', fr: 'Infection', es: 'Infección', ru: 'Инфекция' },
      {
        ...
        ru: 'Имплант не приживается в кости (редко)',
      },
    ],
    steps: [
      {
        title: { tr: 'İmplant Yerleştirme', en: 'Implant Placement', ar: 'وضع الزرعة', fr: 'Pose de l’implant', es: 'Colocación del implante', ru: 'Установка импланта' },
        desc: {
          ...
          ru: 'В челюстной кости формируют ложе и устанавливают винт.',
        },
      },
      {
        title: { tr: 'İyileşme Süreci', en: 'Healing Process', ar: 'عملية الشفاء', fr: 'Période de cicatrisation', es: 'Proceso de cicatrización', ru: 'Период заживления' },
        desc: {
          ...
          ru: 'Ожидается 3–6 месяцев для остеоинтеграции импланта.',
        },
      },
      {
        title: { tr: 'Protez Takılması', en: 'Prosthesis Attachment', ar: 'تثبيت الطرف الاصطناعي', fr: 'Pose de la prothèse', es: 'Colocación de la prótesis', ru: 'Установка коронки' },
        desc: {
          ...
          ru: 'Процедура завершается установкой надстройки (коронки).',
        },
      },
    ],
    faq: [
      {
        ...
        a: {
          ...
          ru: 'Во время процедуры вы не чувствуете боли; после дискомфорт обычно контролируется обезболивающими.',
        },
      },
    ],
  ...
  },
  {
    ...
    title: {
      ...
      ru: 'Голливудская улыбка (дизайн улыбки) — 2026',
    },
    metaDescription: {
      ...
      ru: 'Идеальный дизайн улыбки: «голливудская улыбка» с циркониевыми и ламинированными винирами.',
    },
    summary: {
      ...
      ru: 'Голливудская улыбка — комплексная эстетическая стоматологическая процедура, при которой форму, цвет и размер зубов подбирают под гармонию лица.',
    },
    priceRange: {
    ...
    suitableFor: [
      {
        ...
        ru: 'Недовольные цветом или формой зубов',
      },
      {
        ...
        ru: 'Люди с сколами, кривыми или разреженными зубами',
      },
    ],
    notSuitableFor: [
      {
        ...
        ru: 'При тяжёлых заболеваниях дёсен (сначала требуется лечение)',
      },
    ],
    risks: [
      { tr: 'Diş hassasiyeti', en: 'Tooth sensitivity', ar: 'حساسية الأسنان', fr: 'Sensibilité dentaire', es: 'Sensibilidad dental', ru: 'Чувствительность зубов' },
      {
        ...
        ru: 'Скол винира (при твёрдой пище/предметах)',
      },
    ],
    steps: [
      {
        title: { tr: 'Tasarım ve Hazırlık', en: 'Design and Preparation', ar: 'التصميم والتحضير', fr: 'Conception et préparation', es: 'Diseño y preparación', ru: 'Дизайн и подготовка' },
        desc: {
          ...
          ru: 'Выполняют цифровой дизайн улыбки, подготавливают зубы и снимают слепки/измерения.',
        },
      },
      {
        title: { tr: 'Geçici Dişler', en: 'Temporary Teeth', ar: 'أسنان مؤقتة', fr: 'Dents temporaires', es: 'Dientes temporales', ru: 'Временные зубы' },
        desc: {
          ...
          ru: 'Устанавливают временные накладки до готовности постоянных.',
        },
      },
      {
        title: { tr: 'Final Uygulama', en: 'Final Application', ar: 'التطبيق النهائي', fr: 'Pose finale', es: 'Aplicación final', ru: 'Финальная установка' },
        desc: {
          ...
          ru: 'Индивидуально изготовленные виниры фиксируются.',
        },
      },
    ],
    faq: [
      {
        q: {
          ...
          es: '¿Se ve natural?',
          ru: 'Выглядит ли это естественно?',
        },
        a: {
          ...
          ru: 'Да, подбираются цвет и форма, подходящие к чертам лица и тону кожи.',
        },
      },
    ],
    category: { tr: 'Diş Tedavisi', en: 'Dental Treatment', ar: 'علاج الأسنان' },
  },
  {
    ...
    title: {
      ...
      ru: 'Циркониевые коронки — прочные и эстетичные',
    },
    metaDescription: {
      ...
      ru: 'Преимущества и цены циркониевых коронок — безметалловых керамических реставраций.',
    },
    summary: {
      ...
      ru: 'Цирконий — очень прочный вид коронки: без металла, с высокой светопроницаемостью и хорошей совместимостью с дёснами.',
    },
    priceRange: {
      india: '150 - 300 USD',
      mexico: '300 - 500 USD',
    ...
    notSuitableFor: [
      {
        ...
        ru: 'При бруксизме (нужна ночная капа)',
      },
    ],
    risks: [
      {
        ...
        ru: 'Чувствительность к горячему/холодному (временно)',
      },
    ],
    steps: [
      {
        title: { tr: 'Hazırlık', en: 'Preparation', ar: 'تحضير', fr: 'Préparation', es: 'Preparación', ru: 'Подготовка' },
        desc: {
          ...
          ru: 'Зуб препарируют и снимают слепок/измерения.',
        },
      },
      {
        title: { tr: 'Prova', en: 'Rehearsal', ar: 'بروفة', fr: 'Essayage', es: 'Prueba', ru: 'Примерка' },
        desc: {
          ...
          ru: 'Проводят примерку циркониевого каркаса и керамики.',
        },
      },
      {
        title: { tr: 'Yapıştırma', en: 'Cementation', ar: 'تدعيم', fr: 'Cimentation', es: 'Cementación', ru: 'Фиксация' },
        desc: {
          ...
          ru: 'Выполняют окончательную фиксацию.',
        },
      },
    ],
    faq: [
      {
        ...
        a: {
          ...
          ru: 'Нет, благодаря гладкой поверхности он не окрашивается и не меняет цвет.',
        },
      },
    ],
    category: { tr: 'Diş Tedavisi', en: 'Dental Treatment', ar: 'علاج الأسنان' },
  },
  {
    ...
    metaDescription: {
      ...
      ru: 'Увеличение груди силиконовыми имплантами: виды и цены.',
    },
    summary: {
      ...
      ru: 'Увеличение груди — операция с использованием силиконовых имплантов или липофилинга для увеличения объёма и коррекции формы.',
    },
    priceRange: {
    ...
    suitableFor: [
      ...
      },
      {
        ...
        ru: 'При потере объёма после грудного вскармливания',
      },
      {
    ...
    notSuitableFor: [
      {
        ...
        ru: 'Беременные или кормящие',
      },
    ],
    risks: [
      { tr: 'Kapsül kontraktürü', en: 'Capsular contracture', ar: 'تقلص المحفظة', fr: 'Contracture capsulaire', es: 'Contractura capsular', ru: 'Капсулярная контрактура' },
      {
        ...
        ru: 'Протечка или разрыв импланта (редко)',
      },
    ],
    steps: [
      {
        ...
        desc: {
          ...
          ru: 'Разрез выполняют под грудью, в подмышке или вокруг соска.',
        },
      },
      {
        title: { tr: 'İmplant Yerleştirme', en: 'Implant Placement', ar: 'وضع الزرعة', fr: 'Mise en place de l’implant', es: 'Colocación del implante', ru: 'Установка импланта' },
        desc: {
          ...
          ru: 'Имплант размещают под мышцей или под железой.',
        },
      },
      {
        title: { tr: 'Kapatma', en: 'Closing', ar: 'إغلاق', fr: 'Fermeture', es: 'Cierre', ru: 'Закрытие' },
        desc: {
          ...
          ru: 'Закрывают косметическими швами.',
        },
      },
    ],
    faq: [
      {
        q: {
          ...
          ru: 'Мешает ли грудному вскармливанию?',
        },
        a: {
          ...
          ru: 'Обычно нет, но это может зависеть от места разреза.',
        },
      },
    ],
    category: { tr: 'Estetik Cerrahi', en: 'Plastic Surgery', ar: 'جراحة التجميل' },
  },
  {
    ...
    metaDescription: {
      ...
      ru: 'Методы липосакции Vaser, лазерной и классической: цены и восстановление.',
    },
    summary: {
      ...
      ru: 'Липосакция — это удаление вакуумом устойчивых жировых отложений в определённых зонах для коррекции контуров тела.',
    },
    priceRange: {
      india: '1.500 - 3.000 USD',
      mexico: '2.500 - 4.500 USD',
    ...
    suitableFor: [
      {
        ...
        ru: 'Люди с локальными жировыми отложениями',
      },
      {
        ...
        ru: 'Люди, близкие к своему идеальному весу',
      },
    ],
    notSuitableFor: [
      {
        ...
        ru: 'Пациенты с ожирением (это не метод похудения)',
      },
    ],
    risks: [
      { tr: 'Düzensiz cilt yüzeyi', en: 'Irregular skin surface', ar: 'سطح جلد غير منتظم', fr: 'Irrégularités de la peau', es: 'Irregularidades en la piel', ru: 'Неровности поверхности кожи' },
      { tr: 'Ödem ve morluk', en: 'Edema and bruising', ar: 'وذمة وكدمات', fr: 'Œdème et ecchymoses', es: 'Edema y hematomas', ru: 'Отёк и синяки' },
    ],
    steps: [
      {
        title: { tr: 'İnfiltrasyon', en: 'Infiltration', ar: 'تسلل', fr: 'Infiltration', es: 'Infiltración', ru: 'Инфильтрация' },
        desc: {
          ...
          ru: 'Вводят специальный раствор для облегчения разрушения и удаления жира.',
        },
      },
      {
        title: { tr: 'Yağ Parçalama', en: 'Fat Breaking', ar: 'تكسير الدهون', fr: 'Fragmentation des graisses', es: 'Fragmentación de grasa', ru: 'Разрушение жира' },
        desc: {
          ...
          ru: 'Жир разрушают лазером или ультразвуком (Vaser/laser lipo).',
        },
      },
      {
        title: { tr: 'Aspirasyon', en: 'Aspiration', ar: 'شفط', fr: 'Aspiration', es: 'Aspiración', ru: 'Аспирация' },
        desc: {
    ...
    faq: [
      {
        ...
        a: {
          ...
          ru: 'Удалённые жировые клетки не возвращаются, но оставшиеся могут увеличиваться в размере.',
        },
      },
    ],
    category: { tr: 'Estetik Cerrahi', en: 'Plastic Surgery', ar: 'جراحة التجميل' },
  },
  {
    ...
    title: {
      ...
      ru: 'Рукавная гастрэктомия (уменьшение желудка) — 2026',
    },
    metaDescription: {
      ...
      ru: 'Рукавная гастрэктомия при лечении ожирения: риски, цены и динамика снижения веса.',
    },
    summary: {
      ...
      ru: 'Рукавная гастрэктомия — операция при ожирении, при которой удаляют около 80% желудка, уменьшая его объём. Также снижается выработка гормонов аппетита.',
    },
    priceRange: {
    ...
    suitableFor: [
      ...
      },
      {
        ...
        ru: 'Кто не может снизить вес с помощью диеты',
      },
    ],
    notSuitableFor: [
      {
        ...
        ru: 'При выраженном рефлюксе (возможна рекомендация желудочного шунтирования)',
      },
    ],
    risks: [
      { tr: 'Kaçak riski', en: 'Leakage risk', ar: 'خطر التسرب', fr: 'Risque de fuite', es: 'Riesgo de fuga', ru: 'Риск несостоятельности шва' },
      { tr: 'Vitamin eksikliği', en: 'Vitamin deficiency', ar: 'نقص الفيتامينات', fr: 'Carence en vitamines', es: 'Deficiencia de vitaminas', ru: 'Дефицит витаминов' },
    ],
    steps: [
      {
        title: { tr: 'Giriş', en: 'Entry', ar: 'دخول', fr: 'Accès', es: 'Acceso', ru: 'Доступ' },
        desc: {
          ...
          ru: 'Вход в брюшную полость выполняют лапароскопически (закрытый метод).',
        },
      },
      {
        title: { tr: 'Kesme', en: 'Cutting', ar: 'قطع', fr: 'Résection', es: 'Resección', ru: 'Резекция' },
        desc: {
          ...
          ru: 'Большую часть желудка прошивают степлером, пересекают и удаляют.',
        },
      },
    ],
    faq: [
      {
        ...
        a: {
          ...
          ru: 'В первый год можно потерять 60–70% избыточного веса.',
        },
      },
    ],
  ...
  },
  {
    ...
    title: {
      ...
      ru: 'Лазерная коррекция зрения (LASIK/No Touch) — 2026',
    },
    metaDescription: {
      ...
      ru: 'Цены и виды лазерной коррекции при миопии, гиперметропии и астигматизме.',
    },
    summary: {
      ...
      ru: 'Лазерная коррекция зрения исправляет рефракционные нарушения (потребность в очках), изменяя форму роговицы. Существуют методы LASIK, iLASIK, No Touch и др.',
    },
    priceRange: {
      india: '500 - 1.000 USD',
    ...
    suitableFor: [
      ...
      },
      {
        ...
        ru: 'Те, у кого рецепт не менялся в течение последнего года',
      },
    ],
    notSuitableFor: [
      {
        ...
        ru: 'Люди с слишком тонкой роговицей',
      },
      {
        tr: 'Hamileler',
        en: 'Pregnant women',
    ...
    risks: [
      { tr: 'Göz kuruluğu', en: 'Dry eyes', ar: 'جفاف العين', fr: 'Sécheresse oculaire', es: 'Ojos secos', ru: 'Сухость глаз' },
      {
        ...
        ru: 'Ореолы в ночном зрении (временно)',
      },
    ],
    steps: [
      {
        ...
        desc: {
          ...
          ru: 'Глаз обезболивают.',
        },
      },
      {
        title: { tr: 'Lazer Uygulaması', en: 'Laser Application', ar: 'تطبيق الليزر', fr: 'Application du laser', es: 'Aplicación del láser', ru: 'Лазерное воздействие' },
        desc: {
          ...
          ru: 'Роговицу моделируют эксимерным лазером.',
        },
      },
    ],
    faq: [
      {
        q: { tr: 'Ağrı olur mu?', en: 'Is there pain?', ar: 'هل يوجد ألم؟', fr: 'Y a-t-il une douleur ?', es: '¿Hay dolor?', ru: 'Будет ли боль?' },
        a: {
          ...
          ru: 'Во время процедуры боли нет, после возможно лёгкое жжение.',
        },
      },
    ],
